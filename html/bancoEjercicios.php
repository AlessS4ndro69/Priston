    ...
    <div class="container">
      ...
      <div class="row my-5">
        ...
        for ($j = 0; $j < $numberCourses; $j++){
          ...
          echo '<div class="container"><div class="row justify-content-md-center"><a href="index.php?view=aula&course=Trigonometria" class="btn btn-primary">Más ejercicios de ' . $course . '</a></div></div>';
        }
