          ...
          <div class="card-blog">
            <div class="header">
              <div class="post-thumb">
                <img src="assets/img/grabaciones/' . $grabaciones[$i]['grabacion_curso'] . '.png "  alt="">
              </div>
            </div>
            <div class="body">
              <h5 class="post-title"><a href=' . $grabaciones[$i]['grabacion_link'] . '>' . $grabaciones[$i]['grabacion_curso'] . ' - ' .  $grabaciones[$i]['grabacion_tema'] . '</a></h5>
