      ...
      <div class="row mt-5">
          ...
          <div class="card-pricing">
            <div class="header">
              ...
              <div class="price">
                ...
                <h1>69<span class="suffix">.99</span></h1>
              </div>
              <h5>Al mes</h5>
            </div>
            <div class="body">
            ...
            <div class="footer">
             ...
             <button type="button" class="btn btn-pricing btn-block" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Subscribe</button>
             
             
             <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <?php
                include(HTML_DIR . 'form.html')
              ?>
        ...
        <div class="col-lg-4 py-3 wow zoomIn">
          <div class="card-pricing marked">
            <div class="header">
              <div class="pricing-type">Por apertura</div>
              <div class="price">
                <span class="dollar">S/.</span>
